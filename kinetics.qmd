...
可以得到
$$|\mathbb{J}|=\mathrm{det}(I-\mathrm{d}t^{2}\frac{\partial\mathbf{a}}{\partial\mathbf{x}})$$ {#eq-JacobiCal1}
使用小量展开，当$\epsilon$很小时，
$$\mathrm{det}(I+\epsilon M)=1+\epsilon \mathrm{tr}M+O(\epsilon^2)$$ {#eq-small}
由此得到
